...
public class FirewallManager {
    ...
    private static final String SERVICE_PACKAGE_NAME = "com.gxatek.firewall";
    private static final String SERVICE_CLASS_NAME = "com.gxatek.firewall.service.FirewallService";
    ...
    private FirewallManager(Context context) {
        ...
        boolean state = mContext.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
